...
const myfirstelement = (
  ...
  <div className="four col-sm-12">
    ...
    <div className="client-name col-sm-12">
      ...
      <div className="fou col-sm-4"><div className="client 7"><img src='more.svg' width='150' height='150' alt='More Retail Office'/></div><div className="client 8"><img src='more.svg' width='150' height='150' alt='More Retail Office'/></div></div>
    </div>
  </div>
