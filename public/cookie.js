 ...
 function checkPages(name) {
     if (readPages(name)) {
         ...
         $(document).on('click','#read-id-'+i, function(){
            ...
            createPages(name,"cookie 4 the day",1);console.log("Cookie Added For 1 Day");
